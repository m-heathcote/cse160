...
class Camera {
  ...
  setSkyView() {
    ...
    this.projMat.setPerspective(95, canvas.width/canvas.height, 0.1, 100);
  }

  setCornerView() {
    this.eye = new Vector3([-7.7, 7.7, 7.7]);
    ...
    this.projMat.setPerspective(80, canvas.width/canvas.height, 0.1, 100);
  }
